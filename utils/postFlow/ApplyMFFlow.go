...
func ApplyMfFlow(flows []string, url string, params packetparse.MFParams) (string, error) {
    if len(flows) == 0 {
                ...
                Criteria: []Criteria{
                    {
                        Type: "PROTOCOL_INDEPENDENT",
                        Matches: []Match{
                            {Field: "hdr.ethernet.ether_type", Match: "exact", Value: params.EtherType}, // MF协议EtherType
                            {Field: "hdr.mf.src_guid", Match: "exact", Value: params.SrcGuid},
                            {Field: "hdr.mf.dst_guid", Match: "exact", Value: params.DstGuid},
                        },
                    },
                },
            },
